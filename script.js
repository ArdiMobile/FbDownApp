                ...
                <div style="display:flex;gap:14px;flex-wrap:wrap;">
                    ...
                    <div style="flex:1;min-width:200px;">
                        ...
                        <div style="display:flex;gap:8px;flex-wrap:wrap;">
                            ...
                            <button onclick="window.location.href='page/purchase.html'" style="padding:8px 14px;border:none;background:linear-gradient(135deg,#FEC601,#e6b300);color:#002611;border-radius:20px;font-size:11px;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:5px;" id="credit-link">
